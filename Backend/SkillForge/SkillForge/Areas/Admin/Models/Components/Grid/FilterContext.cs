...
public class FilterContext
{
    ...
    public void Init()
    {
        TextOperatorOptions = new()
        {
            ...
            CreateOperatorOption(EntityFilterService.OPERATOR_STARTS_WITH),
            CreateOperatorOption(EntityFilterService.OPERATOR_ENDS_WITH),
        };
    ...
    protected void FindActiveFilters()
    {
        ...
        if (Table.ListingModel.SearchPhrase != null)
        {
            ...
            {
                PropertyName = nameof(ListingModel.SearchPhrase),
                Name = "Keywords",
