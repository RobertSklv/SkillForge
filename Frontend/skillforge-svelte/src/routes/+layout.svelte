...
{@html `<script type="application/ld+json">
    ${JSON.stringify({
			...
			name: 'SkillForge',
			description:
				'Discover and share high-quality articles on technology, development, and more. Follow tags and authors, engage with the community, and explore trending content.',
			url: getFrontendUrl()
		})}
</script>`}
